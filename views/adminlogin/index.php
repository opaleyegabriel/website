               ...
               <div class="row justify-content-center">
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           <a href="../<?php echo URL; ?>admindashboard" class="navbar-brand d-flex align-items-center text-center justify-content-center mb-3">
                              <!--Logo start-->
                              <!--logo End-->
                              ...
                              <!--logo End-->  
                                ...
                                <!-- <h4 class="logo-title ms-3">DreamCity HES</h4> -->
                           </a>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="username" required name="username" aria-describedby="username" placeholder=" ">
                                       <div id="usernamefeedback" class="text-danger fs-0.1"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       <label for="password" class="form-label">Password</label>
                                       <input type="password" class="form-control" required id="password" name="password" aria-describedby="password" placeholder=" ">
                                       <div id="passwordfeedback" class="text-danger fs-0.1"></div>
                                    </div>
                                 </div>
                              </div>
