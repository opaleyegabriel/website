    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="<?php echo URL; ?>blogcreate"> <i class="icon-home"></i>Blog </a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 block ">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>blogcreate/createblog">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Update blog picture</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="imgurl" placeholder="Change About Page Picture">
													</div>
                        </div>
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Update blog Title</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="text" value="" name="title" placeholder="Update blog title">
													</div>
                        </div>
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Update blog Post</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                            <textarea class="form-control" name="post" rows="8" cols="80" placeholder="Update blog Post"></textarea>
													</div>
                        </div>
