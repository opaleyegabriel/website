    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="<?php echo URL; ?>/changebackgrounds"> <i class="icon-home"></i>Change Backgrounds </a></li>
              ...
              <div class="col-lg-12 block ">
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq1" class="collapsed" data-parent="#faq1">
									      Change first (index) page slider Background
                      </a>
                    </h6>
                    <div id="faq1" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatefirstpagesliderimage1">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Slider 1 Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="slider1" placeholder="Change Slider 2 Background">
													</div>
											...
											<form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatefirstpagesliderimage2">
													<div class="form-group row"  >
														<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Slider 2 Background</label>
														<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
															<input class="form-control" type="file" value="" name="slider2" placeholder="Change Slider 2 Background">
														</div>
														<div class="col-lg-4 col-md-4 col-sm-6 ">
															<button type="submit" class="btn">Save changes</button>
														</div>
											...
											<form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatefirstpagesliderimage3">
													<div class="form-group row"  >
														<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Slider 3 Background</label>
														<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
															<input class="form-control" type="file" value="" name="slider3" placeholder="Change Slider 2 Background">
														</div>
														<div class="col-lg-4 col-md-4 col-sm-6 ">
															<button type="submit" class="btn">Save changes</button>
														</div>
											...
											<form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatefirstpagesliderimage4">
													<div class="form-group row"  >
														<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Slider 4 Background</label>
														<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
															<input class="form-control" type="file" value="" name="slider4" placeholder="Change Slider 2 Background">
														</div>
														<div class="col-lg-4 col-md-4 col-sm-6 ">
															<button type="submit" class="btn">Save changes</button>
														</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq2" class="collapsed" data-parent="#faq1">
									      Change first(index) Our Services Background and Image
                      </a>
                    </h6>
                    <div id="faq2" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updateourservicesimage">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Services Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="services" placeholder="Change Our Services Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                        ...
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updateourservicesrealimage">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Services Image</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="servicesimg" placeholder="Change Our Services Image">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq3" class="collapsed" data-parent="#faq1">
									      Change first(index) Customers Testimony Background
                      </a>
                    </h6>
                    <div id="faq3" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatecustomerstestbg">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Customers Testimony Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="testimony" placeholder="Change Customers Testimony Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq4" class="collapsed" data-parent="#faq1">
									      Change first(index) Best Team Background
                      </a>
                    </h6>
                    <div id="faq4" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatebestteambg">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Best Team Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="team" placeholder="Change Best Team Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq5" class="collapsed" data-parent="#faq1">
									      Change first(index) Price Background
                      </a>
                    </h6>
                    <div id="faq5" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatepricebg">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Price Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="price" placeholder="Change Price Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq6" class="collapsed" data-parent="#faq1">
									      Change first(index) Skills Background
                      </a>
                    </h6>
                    <div id="faq6" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updateskillsbg">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Skills Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="skills" placeholder="Change Skills Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
			               <h6 class="acod-title">
                       <a data-toggle="collapse" href="#faq8" class="collapsed" data-parent="#faq1">
									      Change Website Background <small>(Applicable to places without backgrounds)</small>
                      </a>
                    </h6>
                    <div id="faq8" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changebackgrounds/updatewebsitebg">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Website Background</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="website" placeholder="Change Website Background">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
