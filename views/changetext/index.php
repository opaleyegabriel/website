    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="<?php echo URL; ?>changetext"> <i class="icon-home"></i>Change Text </a></li>
              ...
              <div class="col-lg-12 block ">
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq1" class="collapsed" data-parent="#faq1">
									      Change first (index) Our Services Subtext
                      </a>
                    </h6>
                    <div id="faq1" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changetext/updateservicessubtxt">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Services Subtext </label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea class="form-control" name="servicessubtxt" placeholder="Change Our Services Subtext" rows="3" cols="80"></textarea>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq2" class="collapsed" data-parent="#faq1">
									      Change first (index) Our Customers Subtext
                      </a>
                    </h6>
                    <div id="faq2" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changetext/updatecustomerssubtxt">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Customers Subtext </label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea class="form-control" name="customerssubtxt" placeholder="Change Our Customers Subtext" rows="3" cols="80"></textarea>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq3" class="collapsed" data-parent="#faq1">
									      Change first (index) Our Team Subtext
                      </a>
                    </h6>
                    <div id="faq3" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changetext/updateteamsubtxt">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Team Subtext </label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea class="form-control" name="teamsubtxt" placeholder="Change Our Team Subtext" rows="3" cols="80"></textarea>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq4" class="collapsed" data-parent="#faq1">
									      Change first (index) Our Prices Subtext
                      </a>
                    </h6>
                    <div id="faq4" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changetext/updatepricessubtxt">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Prices Subtext </label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea class="form-control" name="pricessubtxt" placeholder="Change Our Prices Subtext" rows="3" cols="80"></textarea>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq5" class="collapsed" data-parent="#faq1">
									      Change first (index) Our Skills Subtext
                      </a>
                    </h6>
                    <div id="faq5" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>changetext/updateskillssubtxt">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change Our Skills Subtext </label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea class="form-control" name="skillssubtxt" placeholder="Change Our Skills Subtext" rows="3" cols="80"></textarea>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
