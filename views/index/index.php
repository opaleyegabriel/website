...
foreach ($displayproject as $key => $value) {
 ...
 ?>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="58" class="scrollspy-example">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark" id="nav-sticky">
            ...
            <div class="container-fluid">
                ...
                <a class="logo text-uppercase" href="<?php echo URL; ?>index" >
                    ...
                    <img src="<?php echo $logo; ?>" alt="" class="logo-light" width="80px" height="40px" />

                    <img src="<?php echo $logo; ?>" alt="" class="logo-dark" width="80%" height="40%" />
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ms-auto" id="mySidenav">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo URL; ?>policy" class="nav-link">Policy</a>
                        </li>
                    </ul>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 offset-lg-1 col-sm-6">
                                ...
                                <div class="home-img mo-mt-20">
                                    ...
                                    <img src="<?php echo URL; ?>public/images/Gbedun promo flyer.jpg" alt="" class="img-fluid mx-auto d-block">
                                    ...
                                    <div class="col-lg-6 offset-lg-1">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <a href="https://www.dreamcityhes.com/moreprojects" class="btn btn-custom">More Projects <i class="mdi mdi-arrow-right ms-1"></i></a>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div>
                                            ...
                                            <img src="<?php echo URL; ?>public/images/features-img/1280x720_landing.jpg" alt="" class="img-fluid mx-auto d-block">
                            ...
                            <a href="#" class="text-dark">
                                ...
                                <div class="position-relative demo-content">
                                    ...
                                    <div class="demo-img">
                                        ...
                                        <img src="<?php echo URL; ?>public/images/demo/step 1 App interface.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="font-18">Create Account</h5>
                            ...
                            <a href="#" class="text-dark">
                                ...
                                <div class="position-relative demo-content">
                                    ...
                                    <div class="demo-img">
                                        ...
                                        <img src="<?php echo URL; ?>public/images/demo/step 2 App interface.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="font-18">Login to your account</h5>
                            ...
                            <a href="#" class="text-dark">
                                ...
                                <div class="position-relative demo-content">
                                    ...
                                    <div class="demo-img">
                                        ...
                                        <img src="<?php echo URL; ?>public/images/demo/step 3 App interface.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="font-18">Buy from available land</h5>
                            ...
                            <a href="#" class="text-dark">
                                ...
                                <div class="position-relative demo-content">
                                    ...
                                    <div class="demo-img">
                                        ...
                                        <img src="<?php echo URL; ?>public/images/demo/step 4 App interface.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="font-18">Simple DashBoard After Online Payment</h5>
                            ...
                            <a href="#" class="text-dark">
                                ...
                                <div class="position-relative demo-content">
                                    ...
                                    <div class="demo-img">
                                        ...
                                        <img src="<?php echo URL; ?>public/images/demo/step 5 App interface.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="font-18">Make subsequent payments</h5>
        ...
        <section class="section" id="demo">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="title text-center">
                            <h6 class="text-primary small-title"><?php echo $staffheadertext ?></h6>
                            <h4><?php echo $staffsubtext ?></h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="product-carousel">
                        ...
                        require_once  ('models/index_model.php');
                        $myData= new Index_model();
                        $displaystaffdata=($myData->staffdata());
                        foreach ($displaystaffdata as $row) {
                          // $servicetext=$value['servicetext'];
                          // $servicedesc=$value['servicedesc'];
                        ...
                        <div class="items">
                          <div class="demo-box text-center p-3 mt-4">
                              <a href="#" class="text-dark">
                                  <div class="position-relative demo-content">
                                      <div class="demo-img">
                                          <img src="<?php echo $row['staffpicture'] ?>" alt="" class="img-fluid mx-auto d-block rounded">
                                      </div>
                                      <div class="demo-overlay">
                                          <div class="overlay-icon">
                                              <p class="h1 text-white"><?php echo $row['branch'] ?></p>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="mt-3">
                                      <h5 class="font-18"><?php echo $row['staffname'] ?></h5>
                                      <h6 class="font-12"><?php echo $row['staffposition'] ?></h6>
                                  </div>
                              </a>
                          </div>
                      </div>
        ...
        <!-- testimony input start -->
        <section class="section" id="contact">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="title text-center mb-5">
                            <h6 class="text-primary small-title">Review Us</h6>
                            <!-- <h4><?php echo $contactheadertext ?></h4> -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="custom-form bg-white">
                            <span id="error-msg"></span>
                                <form method="post" name="myForm"  enctype="multipart/form-data" action="<?php echo URL; ?>index/savetestimony">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Name</label>
                                            <input name="clientname" id="name" type="text" class="form-control" placeholder="Enter your name..." required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="clientoccupation" class="form-label">Occupation</label>
                                            <input name="clientoccupation" id="clientoccupation" type="text" class="form-control" placeholder="Enter your Occupation" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="sitepurchased" class="form-label">Site Purchased</label>
                                            <input name="sitepurchased" id="sitepurchased" type="text" class="form-control" placeholder="Enter Site Purchased..." required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="clientpicture" class="form-label">Upload Picture</label>
                                            <input type="file" name="clientpicture" class="form-control"  required>
                                        </div>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="testimony" id="testimony" rows="4" class="form-control" placeholder="Enter your Testimony..." required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-end">
                                        <input type="submit" id="submit" name="send" class="submitBnt btn btn-custom" value="Send Testimony" />
                                    </div>
                                </div>
                                <!-- end row -->
                            </form>
