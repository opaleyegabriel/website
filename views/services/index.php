      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Add Services</h2>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 block ">
                <form class="edit-profile " method="post" enctype="multipart/form-data" action="<?php echo URL; ?>services/saveservice">
                  <div class="form-group"  >
                  <label class="col-form-label">Service Header </label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <input type="text" class="form-control" name="serviceheader" value="" placeholder="Service Header">
                  </div>
                </div>
                  <div class="form-group"  >
                  <label class="col-form-label">Service </label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <textarea class="form-control" name="service" value="" placeholder="Service" rows="3" cols="80"></textarea>
                  </div>
                </div>
