          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 block ">
                <form class="edit-profile " method="post" enctype="multipart/form-data" action="<?php echo URL; ?>team/saveteam">
                  <div class="form-group"  >
                  <label class="col-form-label">Staff Name </label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <input type="text" class="form-control" name="staffname" value="" placeholder="Staff Name">
                  </div>
                </div>
                  <div class="form-group"  >
                  <label class="col-form-label">Position Held </label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <input class="form-control" name="staffposition" value="" placeholder="Position Held" type="text">
                  </div>
                </div>
                <div class="form-group"  >
                <label class="col-form-label">Staff Picture </label>
                <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                  <input type="file" class="form-control" name="staffpicture" value="">
                </div>
              </div>
