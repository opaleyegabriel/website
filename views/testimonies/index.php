    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="<?php echo URL; ?>services"> <i class="icon-home"></i>Services </a></li>
                <li class="active"><a href="<?php echo URL; ?>team"> <i class="icon-home"></i>Team </a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Add Staff (Team)</h2>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 block ">
                <form class="edit-profile " method="post" enctype="multipart/form-data" action="<?php echo URL; ?>testimonies/savetestimonies">
                  <div class="form-group"  >
                  <label class="col-form-label">Client Name </label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <input type="text" class="form-control" name="clientname" value="" placeholder="Client Name">
                  </div>
                </div>
                  <div class="form-group"  >
                  <label class="col-form-label">Designation</label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                    <input class="form-control" name="designation" value="" placeholder="Designation" type="text">
                  </div>
                </div>
                <div class="form-group"  >
                  <label class="col-form-label">Testimony</label>
                  <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                  <textarea class="form-control" name="testimony" value="" placeholder="testimony" rows="3" cols="80"></textarea>
                  </div>
                </div>
                <div class="form-group"  >
                <label class="col-form-label">Client Picture </label>
                <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
                  <input type="file" class="form-control" name="clientpicture" value="">
                </div>
              </div>
          ...
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              <!-- Please do not remove the backlink to us unless you support us at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
               <p class="no-margin-bottom">2023 &copy; DreamCityHES Ltd</p>
            </div>
          </div>
        </footer>
      </div>
