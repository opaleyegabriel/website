    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="<?php echo URL; ?>updateabt"> <i class="icon-home"></i>About Page </a></li>
              ...
              <div class="col-lg-12 block ">
                <div class="acod-head">
                       ...
                       <a data-toggle="collapse" href="#faq1" class="collapsed" data-parent="#faq1">
									      Change About Page Picture
                      </a>
                    </h6>
                    <div id="faq1" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>updateabt/updateabtpicture">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change About Page Picture</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="file" value="" name="abtpicture" placeholder="Change About Page Picture">
													</div>
                ...
                <div class="acod-head">
                    ...
                    <div id="faq2" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>updateabt/updateabtheader">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change About Page Header</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<input class="form-control" type="text" value="" name="abtheader" placeholder="Change About Page Header">
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
                ...
                <div class="acod-head">
                    ...
                    <div id="faq3" class="acod-body collapse">
                      <div class="acod-content">
                        <form class="edit-profile m-b30" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>updateabt/updateabtcontent">
                          <div class="form-group row"  >
													<label class="col-lg-2 col-md-2 col-sm-6 col-form-label">Change About Page Content</label>
													<div class="col-lg-6 col-md-6 col-sm-6 " style="margin-bottom:15px;">
														<textarea name="abtcontent" class="form-control" rows="3" cols="80"></textarea>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 ">
														<button type="submit" class="btn">Save changes</button>
													</div>
